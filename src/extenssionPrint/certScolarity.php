...
<div>
	...
	<div style="text-align: justify;" class="text-xs">
		...
		<em>Date de naissance : </em><b><em><?php 
		$dateFormat = new DateTime($stdA['dateNaissance']);
		echo $dateFormat->format('d F Y');
		?></em></b><br>
		...
		<p style="text-indent: 40px;">Est inscrit(e) dans la FACULTÉ de <b><?= $stdA['etude_envisage']?></b> de notre Institution, comme étudiant(e) régulièr(e), en <b><?= $etude_option?></b> pour cette année universitaire <?=$stdA['annee_scolaire']?>.</p><br>

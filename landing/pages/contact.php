    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">
                Une question, une demande d'information ou besoin d'assistance ? 
            ...
            <div class="contact-info-list">
                ...
                <div class="contact-item">
                    ...
                    <div class="contact-details">
                        <h4>Adresse</h4>
                        <p>Ambohitsoa, Sambaina<br>Manjakandriana 119<br>Madagascar</p>
                    </div>
                </div>
                ...
                <div class="contact-item">
                    ...
                    <div class="contact-details">
                        <h4>Téléphone</h4>
                        <p>
                            <a href="tel:+261341234567">+261 34 46 000 08</a><br>
                            <a href="tel:+261331234567">+261 34 76 076 98</a>
                        </p>
                    </div>
                </div>
                ...
                <div class="contact-item">
                    ...
                    <div class="contact-details">
                        <h4>Email</h4>
                        <p>
                            <a href="mailto:registraroffice@zurcher.edu.mg">registraroffice@zurcher.edu.mg</a><br>
                            <a href="mailto:office@zurcher.edu.mg">office@zurcher.edu.mg</a>
                        </p>
                    </div>
                </div>
                ...
                <div style="margin-top: 30px;">
                    <h4 style="margin-bottom: 16px; font-size: 16px;">Suivez-nous</h4>
                    <div class="footer-social">
                        <a href="https://facebook.com/uazurcher" class="social-link" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                            </svg>
                        </a>
                        <a href="https://twitter.com/uazurcher" class="social-link" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                            </svg>
                        </a>
                        <a href="https://instagram.com/uazurcher" class="social-link" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <a href="https://youtube.com/@uazurcher" class="social-link" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="form-container">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="phone" name="phone" class="form-input" placeholder="+261 34 XX XXX XX">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="subject" name="subject" class="form-select" required>
                            ...
                            <option value="admission">Renseignements sur les admissions</option>
                            <option value="formation">Questions sur les formations</option>
                            <option value="frais">Frais de scolarité et bourses</option>
                            <option value="campus">Vie sur le campus</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="message" name="message" class="form-textarea" placeholder="Décrivez votre demande en détail..." required></textarea>
                    </div>
    ...
    <section class="section section-alt">
        <div class="section-header">
            ...
            <p class="section-subtitle">
                Notre campus est facilement accessible depuis Antananarivo
            </p>
        </div>
    ...
    <section class="section">
        ...
        <div class="cards-grid" style="max-width: 900px; margin: 0 auto;">
            <div class="feature-card">
                <h3 class="card-title">Comment candidater à l'UAZ ?</h3>
                <p class="card-text">
            ...
            <div class="feature-card">
                <h3 class="card-title">Quels sont les frais de scolarité ?</h3>
                <p class="card-text">
            ...
            <div class="feature-card">
                <h3 class="card-title">Y a-t-il un hébergement sur le campus ?</h3>
                <p class="card-text">
            ...
            <div class="feature-card">
                <h3 class="card-title">Comment accéder au campus ?</h3>
                <p class="card-text">

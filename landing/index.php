...
<head>
    ...
    <link rel="stylesheet" href="<?=$app_base?>/landing/landing.css">
</head>
<body>
    ...
    <nav>
        ...
        <div class="nav-right">
            ...
            <a href="<?=$app_base?>/formations" class="nav-link">Formations</a>
            <a href="<?=$app_base?>/admissions" class="nav-link">Admissions</a>
            <a href="<?=$app_base?>/campus" class="nav-link">Campus</a>
            <a href="<?=$app_base?>/contact" class="nav-link">Contact</a>
    ...
    <script src="<?=$app_base?>/landing/landing.js"></script>
</body>
</html>

<?php 
	...
	$cours_cout = $_GET['cours_cout'];
	$lab_cout = $_GET['lab_cout'];
	...
	$findCoutFromFinance = $dtb->query("SELECT * FROM t_2024_etudiant_finace WHERE student_id='".$student_id."' AND session_id='".$session_id."'");
